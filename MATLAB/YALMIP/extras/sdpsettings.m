...
if (nargin>0) && isstruct(varargin{1})
    ...
    Names = appendOptionNames(Names,options.sdpa_gmp,'sdpa_gmp');
...
sdpa_gmp.path2sdpagmp = '~/Downloads/sdpa-gmp-7.1.3/' ;
...
% sdpa_gmp.epsilonDash  = 1.0E-25 ;
% sdpa_gmp.precision = 200 ;
% sdpa_gmp.path2sdpagmp = '~/Downloads/sdpa-gmp-7.1.3.src.20150320/sdpa-gmp-7.1.3/' ;
