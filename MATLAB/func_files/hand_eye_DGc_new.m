function [D, G, c, coef_f_q_sym, coef_J_pure, coefs_tq, pinvG] = hand_eye_DGc_new(A, B)
len = size(A, 3);
...
D = D_func_hand_eye_new(coef_f_q_sym(1, :), coef_f_q_sym(2, :), coef_f_q_sym(3, :), coef_f_q_sym(4, :));
G = G_func_hand_eye_new(coef_f_q_sym(1, :), coef_f_q_sym(2, :), coef_f_q_sym(3, :), coef_f_q_sym(4, :));
c = c_func_hand_eye_new(coef_f_q_sym(1, :), coef_f_q_sym(2, :), coef_f_q_sym(3, :), coef_f_q_sym(4, :));
end