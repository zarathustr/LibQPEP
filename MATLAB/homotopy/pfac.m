...
%          >> [P,res,fcnd] = PolynomialFactor(f)
%          >> [P,res,fcnd] = PolynomialFactor(f, tol)
%          >> [P,res,fcnd] = PolynomialFactor(f, tol, style)
%          >> [P,res,fcnd] = PolynomialFactor(f, tol, style, sf)
%          >> [P,res,fcnd] = PolynomialFactor(f, tol, style, sf, gn)
%
